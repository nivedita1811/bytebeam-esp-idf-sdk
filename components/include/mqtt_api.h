...
void *NWY_IOT_MQTT_Construct(iotx_mqtt_param_t *pInitParams);
...
/*Begin:modify add by lixianhong for alimqtt msg max len */
//#define CONFIG_MQTT_MESSAGE_MAXLEN              (3072)
#define CONFIG_MQTT_MESSAGE_MAXLEN              (1024 * 10 + 128)
/*End:modify add by lixianhong for alimqtt msg max len */
...
#define CONFIG_MQTT_REQ_TIMEOUT_MAX             (60000)
